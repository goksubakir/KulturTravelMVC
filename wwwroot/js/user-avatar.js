/* ========== KULLANICI AVATAR VE AD GÖSTERİMİ (TÜM SAYFALAR İÇİN) ========== */
document.addEventListener("DOMContentLoaded", () => {
    const nav = document.querySelector("nav");
    if (!nav) return; // Nav yoksa çık
    ...
    if (loggedIn === "true" && user) {
      ...
      // Eğer zaten avatar varsa tekrar oluşturma
      if (nav.querySelector(".avatar-container")) return;
      ...
      avatar.innerHTML = `
        ...
        <svg class="dropdown-arrow" width="8" height="8" viewBox="0 0 12 12" fill="currentColor">
